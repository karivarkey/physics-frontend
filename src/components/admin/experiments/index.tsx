          ...
          >
            ...
            <div className="mt-4 flex gap-2">
              <Button
                ...
                onClick={() => {
                  navigate(`/admin/experiment/${experiment.id}`);
                }}
              >
                Open
              </Button>
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setCreateDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Provide a title and description for your new experiment. You can
                add questions after it's created.
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Textarea
                  ...
                  className="col-span-3"
                  placeholder="A short description of the experiment's objective."
                />
              </div>
            </div>
            <DialogFooter>
